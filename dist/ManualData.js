...
class ManualData {
    ...
    initCustomerRoom() {
        ...
        this.customerManagement.createCustomerRoom(customerRoom1);
        this.customerManagement.createCustomerRoom(customerRoom2);
        this.customerManagement.createCustomerRoom(customerRoom3);
        this.customerManagement.createCustomerRoom(customerRoom4);
        this.customerManagement.createCustomerRoom(customerRoom5);
        this.customerManagement.createCustomerRoom(customerRoom6);
    }
}
